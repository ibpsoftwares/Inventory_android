...
public class ViewProductAchiveAdapter extends RecyclerView.Adapter<ViewProductAchiveAdapter.MyViewHolder> {
    ...
    public ViewProductAchiveAdapter(Context mContext, ArrayList<ProductModel> arrayList, Deleter_Edit_Interface deleter_edit_interface) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.grid_restore_new, parent, false);
