...
public class ViewProductAdapterUpdated extends RecyclerView.Adapter<ViewProductAdapterUpdated.MyViewHolder> {
    ...
    public ViewProductAdapterUpdated(Context mContext, ArrayList<ProductModel> arrayList, Deleter_Edit_Interface deleter_edit_interface) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int positions) {
        ...
        if (!mArrayList.get(positions).isValueSet()) {
            ...
            Log.e("Value is true", "Already Loaded");
        }
